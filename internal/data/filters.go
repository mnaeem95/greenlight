...
// Check that the client-provided Sort field matches one of the entries in our safelist and if it does, extract the column name
// from the Sort field by stripping the leading hyphen character (if one exists).
