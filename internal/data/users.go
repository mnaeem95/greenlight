...
func ValidateUser(v *validator.Validator, user *User) {
	...
	// If the password hash is ever nil, this will be due to a logic error in our codebase (probably because we forgot to set a password for the user).
...
func (m UserModel) Insert(user *User) error {
	...
	// If the table already contains a record with this email address, then when we try to perform the insert there will be a violation of the
	// UNIQUE "users_email_key" constraint. We check for this error specifically, and return custom ErrDuplicateEmail error instead.
